      ...
      <div class="article">
        ...
        <div style="margin: 1rem 0;">
          ...
          <div style="margin-top: 0.5rem;">
            <button id="day08-visualize" class="btn" style="margin-right: 0.5rem;">[Visualize]</button>
            <button id="day08-reveal" class="btn" style="margin-right: 0.5rem;">[Reveal Solution]</button>
          </div>
        </div>

        <div id="day08-results" style="margin-top:1rem;"></div>
      </div>
    `;
  },
  attachHandlers() {
    ...
    const revealBtn = document.getElementById('day08-reveal');
    const resultsEl = document.getElementById('day08-results');
