export default {
      ...
      <div class="article">
        ...
        <div style="margin: 1rem 0;">
          ...
          <div style="margin-top: 0.5rem;">
            <button id="day06-visualize" class="btn" style="margin-right: 0.5rem;">[Visualize]</button>
            <button id="day06-reveal" class="btn" style="margin-right: 0.5rem;">[Reveal Solution]</button>
          </div>
        </div>
  ...
  attachHandlers() {
    ...
    const visualizeBtn = document.getElementById('day06-visualize');
